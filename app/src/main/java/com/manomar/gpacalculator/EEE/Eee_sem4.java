...
public class Eee_sem4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cal_gpa = findViewById(R.id.btn_eee_gpa_sem4);
        getSupportActionBar().setTitle("EEE Semester 4");


        spinner1 = findViewById(R.id.eee_sem4_spin1);
        spinner2 = findViewById(R.id.eee_sem4_spin2);
        spinner3 = findViewById(R.id.eee_sem4_spin3);
        spinner4 = findViewById(R.id.eee_sem4_spin4);
        spinner5 = findViewById(R.id.eee_sem4_spin5);
        spinner6 = findViewById(R.id.eee_sem4_spin6);
        spinner7 = findViewById(R.id.eee_sem4_spin7);
        spinner8 = findViewById(R.id.eee_sem4_spin8);

        spinner9 = findViewById(R.id.eee_sem4_spin9);
        //spinner10 = findViewById(R.id.eee_sem4_spin10);
    ...
    public void calculateGPA() {
        ...
        if (subject1.equals("Your grade") || subject2.equals("Your grade") || subject3.equals("Your grade")
            ...
            Intent intent = new Intent(Eee_sem4.this, GPA_ResultActivity.class);

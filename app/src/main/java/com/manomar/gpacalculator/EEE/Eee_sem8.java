...
public class Eee_sem8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cal_gpa = findViewById(R.id.btn_eee_gpa_sem8);
        getSupportActionBar().setTitle("EEE Semester 8");

        ActionBar actionBar = getSupportActionBar();
        actionBar.setDisplayShowHomeEnabled(true);
        actionBar.setDisplayHomeAsUpEnabled(true);

        spinner1 = findViewById(R.id.eee_sem8_spin1);
        spinner2 = findViewById(R.id.eee_sem8_spin2);
    ...
    public void calculateGPA() {
        ...
        if (subject1.equals("Your grade") || subject2.equals("Your grade")) {
            ...
            Intent intent = new Intent(Eee_sem8.this, GPA_ResultActivity.class);

...
public class Mech_sem3 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cal_gpa = findViewById(R.id.btn_mech_gpa_sem3);

        getSupportActionBar().setTitle("Mechanical Semester 3");
        ActionBar actionBar = getSupportActionBar();
        actionBar.setDisplayShowHomeEnabled(true);
        actionBar.setDisplayHomeAsUpEnabled(true);


        spinner1 = findViewById(R.id.mech_sem3_spin1);
        spinner2 = findViewById(R.id.mech_sem3_spin2);
        spinner3 = findViewById(R.id.mech_sem3_spin3);
        spinner4 = findViewById(R.id.mech_sem3_spin4);
        spinner5 = findViewById(R.id.mech_sem3_spin5);
        spinner6 = findViewById(R.id.mech_sem3_spin6);
        spinner7 = findViewById(R.id.mech_sem3_spin7);
        spinner8 = findViewById(R.id.mech_sem3_spin8);

        spinner9 = findViewById(R.id.mech_sem3_spin9);
        //spinner10 = findViewById(R.id.mech_sem3_spin10);
    ...
    public void calculateGPA() {
        ...
        if (subject1.equals("Your grade") || subject2.equals("Your grade") || subject3.equals("Your grade")
            ...
            Intent intent = new Intent(Mech_sem3.this, GPA_ResultActivity.class);

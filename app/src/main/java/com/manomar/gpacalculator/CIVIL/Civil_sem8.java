...
public class Civil_sem8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cal_gpa = findViewById(R.id.btn_civil_gpa_sem8);
        getSupportActionBar().setTitle("Civil Semester 8");
        ActionBar actionBar = getSupportActionBar();
        actionBar.setDisplayShowHomeEnabled(true);
        actionBar.setDisplayHomeAsUpEnabled(true);

        spinner1 = findViewById(R.id.civil_sem8_spin1);
    ...
    public void calculateGPA() {
        ...
        if (subject1.equals("Your grade")) {
            ...
            Intent intent = new Intent(Civil_sem8.this, GPA_ResultActivity.class);

...
public class AD_Sem8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ad_sem8);

        ActionBar actionBar = getSupportActionBar();
        actionBar.setDisplayShowHomeEnabled(true);
        actionBar.setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setTitle("AIDS Semester 8");

        cal_gpa = findViewById(R.id.btn_aids_gpa_sem8);

        spinner1 = findViewById(R.id.aids_sem8_spin1);
        spinner2 = findViewById(R.id.aids_sem8_spin2);
    ...
    public void calculateGPA() {
        ...
        if (subject1.equals("Your grade") || subject2.equals("Your grade")) {
            ...
            Intent intent = new Intent(AD_Sem8.this, GPA_ResultActivity.class);

...
public class AD_Sem7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ad_sem7);

        ActionBar actionBar = getSupportActionBar();
        actionBar.setDisplayShowHomeEnabled(true);
        actionBar.setDisplayHomeAsUpEnabled(true);
        getSupportActionBar().setTitle("AIDS Semester 7");

        cal_gpa = findViewById(R.id.btn_aids_gpa_sem7);


        spinner1 = findViewById(R.id.aids_sem7_spin1);
        spinner2 = findViewById(R.id.aids_sem7_spin2);
        spinner3 = findViewById(R.id.aids_sem7_spin3);
        spinner4 = findViewById(R.id.aids_sem7_spin4);
        spinner5 = findViewById(R.id.aids_sem7_spin5);
        spinner6 = findViewById(R.id.aids_sem7_spin6);
        spinner7 = findViewById(R.id.aids_sem7_spin7);
        spinner8 = findViewById(R.id.aids_sem7_spin8);
    ...
    public void calculateGPA() {
        ...
        if (subject1.equals("Your grade") || subject2.equals("Your grade") || subject3.equals("Your grade")
            ...
            Intent intent = new Intent(AD_Sem7.this, GPA_ResultActivity.class);

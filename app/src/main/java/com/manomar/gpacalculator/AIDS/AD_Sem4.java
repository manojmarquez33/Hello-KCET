...
public class AD_Sem4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_ad_sem4);

        getSupportActionBar().setTitle("AIDS Semester 4");
        ActionBar actionBar = getSupportActionBar();
        actionBar.setDisplayShowHomeEnabled(true);
        actionBar.setDisplayHomeAsUpEnabled(true);

        cal_gpa = findViewById(R.id.btn_aids_gpa_sem4);


        spinner1 = findViewById(R.id.aids_sem4_spin1);
        spinner2 = findViewById(R.id.aids_sem4_spin2);
        spinner3 = findViewById(R.id.aids_sem4_spin3);
        spinner4 = findViewById(R.id.aids_sem4_spin4);
        spinner5 = findViewById(R.id.aids_sem4_spin5);
        spinner6 = findViewById(R.id.aids_sem4_spin6);
        spinner7 = findViewById(R.id.aids_sem4_spin7);
        spinner8 = findViewById(R.id.aids_sem4_spin8);
        spinner9 = findViewById(R.id.aids_sem4_spin9);
    ...
    public void calculateGPA() {
        ...
        if (subject1.equals("Your grade") || subject2.equals("Your grade") || subject3.equals("Your grade")
           ...
           if (subject9.equals("O - Outstanding")) {
            ...
            Intent intent = new Intent(AD_Sem4.this, GPA_ResultActivity.class);

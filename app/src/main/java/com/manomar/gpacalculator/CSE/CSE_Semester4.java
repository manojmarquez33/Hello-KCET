...
public class CSE_Semester4 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cse_semester4);

        cal_gpa = findViewById(R.id.btn_cse_gpa_sem4);

        getSupportActionBar().setTitle("CSE Semester 4");
        ActionBar actionBar = getSupportActionBar();
        actionBar.setDisplayShowHomeEnabled(true);
        actionBar.setDisplayHomeAsUpEnabled(true);


        spinner1 = findViewById(R.id.cse_sem4_spin1);
        spinner2 = findViewById(R.id.cse_sem4_spin2);
        spinner3 = findViewById(R.id.cse_sem4_spin3);
        spinner4 = findViewById(R.id.cse_sem4_spin4);
        spinner5 = findViewById(R.id.cse_sem4_spin5);
        spinner6 = findViewById(R.id.cse_sem4_spin6);
        spinner7 = findViewById(R.id.cse_sem4_spin7);
        spinner8 = findViewById(R.id.cse_sem4_spin8);
        spinner9 = findViewById(R.id.cse_sem4_spin9);
    ...
    public void calculateGPA() {
        ...
        if (subject1.equals("Your grade") || subject2.equals("Your grade")|| subject3.equals("Your grade")
            ...
            int total_credits = 25;
                ...
                float total_sem4 = sub1 + sub2 + sub3 + sub4 + sub5 + sub6 + sub7 + sub8 + sub9;
                double gpa_sem4 = total_sem4 / total_credits;


                cal_gpa.setClickable(true);
                Intent intent = new Intent(CSE_Semester4.this, GPA_ResultActivity.class);

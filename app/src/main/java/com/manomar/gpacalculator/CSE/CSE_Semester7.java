...
public class CSE_Semester7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cse_semester7);

        cal_gpa = findViewById(R.id.btn_cse_gpa_sem7);

        getSupportActionBar().setTitle("CSE Semester 7");
        ActionBar actionBar = getSupportActionBar();
        actionBar.setDisplayShowHomeEnabled(true);
        actionBar.setDisplayHomeAsUpEnabled(true);


        spinner1 = findViewById(R.id.cse_sem7_spin1);
        spinner2 = findViewById(R.id.cse_sem7_spin2);
        spinner3 = findViewById(R.id.cse_sem7_spin3);
        spinner4 = findViewById(R.id.cse_sem7_spin4);
        spinner5 = findViewById(R.id.cse_sem7_spin5);
        spinner6 = findViewById(R.id.cse_sem7_spin6);
        spinner7 = findViewById(R.id.cse_sem7_spin7);
        spinner8 = findViewById(R.id.cse_sem7_spin8);
        spinner9 = findViewById(R.id.cse_sem7_spin9);
    ...
    public void calculateGPA() {
        ...
        if (subject1.equals("Your grade") || subject2.equals("Your grade")|| subject3.equals("Your grade")
            ...
            if (subject1.equals("Your grade")) {
                Toast.makeText(this, "MA2201 is empty", Toast.LENGTH_SHORT).show();
            } else if (subject1.equals("O - Outstanding")) {
                sub1 = 3 * 10;
            ...
            //--------------------------------------------------------------------
            int sub2 = 0;
            if (subject2.equals("Your grade")) {
                Toast.makeText(this, "IT2201 is empty", Toast.LENGTH_SHORT).show();
            } else if (subject2.equals("O - Outstanding")) {
                sub2 = 3 * 10;
            ...
            int sub3 = 0;
            if (subject3.equals("Your grade")) {
                Toast.makeText(this, "CS2201 is empty", Toast.LENGTH_SHORT).show();
            } else if (subject3.equals("O - Outstanding")) {
                sub3 = 3 * 10;
            ...
            //-----------------------------------------------------------------------
            int sub4 = 0;
            if (subject4.equals("Your grade")) {
                Toast.makeText(this, "CS2202 is empty", Toast.LENGTH_SHORT).show();
            } else if (subject4.equals("O - Outstanding")) {
                sub4 = 3 * 10;
            ...
            // --------------------------------------------------------------
            int sub5 = 0;
            if (subject5.equals("Your grade")) {
                Toast.makeText(this, "CS2203 is empty", Toast.LENGTH_SHORT).show();
            } else if (subject5.equals("O - Outstanding")) {
                sub5 = 3 * 10;
            ...
            //--------------------------------------------------------------------
            int sub6 = 0;
            if (subject6.equals("Your grade")) {
                Toast.makeText(this, "EC2201 is empty", Toast.LENGTH_SHORT).show();
            } else if (subject6.equals("O - Outstanding")) {
                sub6 = 3 * 10;
            ...
            if (subject7.equals("Your grade")) {
                Toast.makeText(this, "CS2204 is empty", Toast.LENGTH_SHORT).show();
            } else if (subject7.equals("O - Outstanding")) {
                sub7 = 2 * 10;
            ...
            //------------------------------------------------------------------------------
            int sub8 = 0;
            if (subject8.equals("Your grade")) {
                Toast.makeText(this, "EC2202 is empty", Toast.LENGTH_SHORT).show();
            } else if (subject8.equals("O - Outstanding")) {
                sub8 = 2 * 10;
            ...
            int sub9 = 0;
            if (subject9.equals("Your grade")) {
                Toast.makeText(this, "EC2202 is empty", Toast.LENGTH_SHORT).show();
            } else if (subject9.equals("O - Outstanding")) {
                sub9 = 2 * 10;
                ...
                sub9 = 2 * 0;
            } else if (subject9.equals("WH - Malpractice")) {
                sub9 = 2 * 0;
            }


            float total_sem7 = sub1 + sub2 + sub3 + sub4 + sub5 + sub6 + sub7 + sub8 + sub9;
            double gpa_sem7 = total_sem7 / total_credits;

...
public class CSE_Semester8 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_cse_semester8);

        cal_gpa = findViewById(R.id.btn_cse_gpa_sem8);

        getSupportActionBar().setTitle("CSE Semester 8");
        ActionBar actionBar = getSupportActionBar();
        actionBar.setDisplayShowHomeEnabled(true);
        actionBar.setDisplayHomeAsUpEnabled(true);

        spinner1 = findViewById(R.id.cse_sem8_spin1);
        spinner2 = findViewById(R.id.cse_sem8_spin2);
    ...
    public void calculateGPA() {
        ...
        if (subject1.equals("Your grade") || subject2.equals("Your grade")) {
            ...
            Intent intent = new Intent(CSE_Semester8.this, GPA_ResultActivity.class);

...
public class BT_sem7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_bt_sem7);

        cal_gpa = findViewById(R.id.btn_bt_gpa_sem7);
        getSupportActionBar().setTitle("BioTech Semester 7");
        ActionBar actionBar = getSupportActionBar();
        actionBar.setDisplayShowHomeEnabled(true);
        actionBar.setDisplayHomeAsUpEnabled(true);


        spinner1 = findViewById(R.id.bt_sem7_spin1);
        spinner2 = findViewById(R.id.bt_sem7_spin2);
        spinner3 = findViewById(R.id.bt_sem7_spin3);
        spinner4 = findViewById(R.id.bt_sem7_spin4);
        spinner5 = findViewById(R.id.bt_sem7_spin5);
        spinner6 = findViewById(R.id.bt_sem7_spin6);
        spinner7 = findViewById(R.id.bt_sem7_spin7);
        spinner8 = findViewById(R.id.bt_sem7_spin8);

        spinner9 = findViewById(R.id.bt_sem7_spin9);
        // spinner10 = findViewById(R.id.bt_sem7_spin10);
    ...
    public void calculateGPA() {
        ...
        if (subject1.equals("Your grade") || subject2.equals("Your grade") || subject3.equals("Your grade")
            ...
            Intent intent = new Intent(BT_sem7.this, GPA_ResultActivity.class);

...
public class Mechatro_sem7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        spinner1 = findViewById(R.id.mtr_sem7_spin1);
        spinner2 = findViewById(R.id.mtr_sem7_spin2);
        spinner3 = findViewById(R.id.mtr_sem7_spin3);
        spinner4 = findViewById(R.id.mtr_sem7_spin4);
        spinner5 = findViewById(R.id.mtr_sem7_spin5);
        spinner6 = findViewById(R.id.mtr_sem7_spin6);
        spinner7 = findViewById(R.id.mtr_sem7_spin7);
        spinner8 = findViewById(R.id.mtr_sem7_spin8);

        //spinner9 = findViewById(R.id.mtr_sem7_spin9);
        //spinner10 = findViewById(R.id.mtr_sem7_spin10);

...
public class Mechatro_sem5 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mechatro_sem5);

        cal_gpa = findViewById(R.id.btn_mtr_gpa_sem5);

        getSupportActionBar().setTitle("Mechatronics Semester 5");
        ActionBar actionBar = getSupportActionBar();
        actionBar.setDisplayShowHomeEnabled(true);
        actionBar.setDisplayHomeAsUpEnabled(true);


        spinner1 = findViewById(R.id.mtr_sem5_spin1);
        spinner2 = findViewById(R.id.mtr_sem5_spin2);
        spinner3 = findViewById(R.id.mtr_sem5_spin3);
        spinner4 = findViewById(R.id.mtr_sem5_spin4);
        spinner5 = findViewById(R.id.mtr_sem5_spin5);
        spinner6 = findViewById(R.id.mtr_sem5_spin6);
        spinner7 = findViewById(R.id.mtr_sem5_spin7);
        spinner8 = findViewById(R.id.mtr_sem5_spin8);

        spinner9 = findViewById(R.id.mtr_sem5_spin9);
        //spinner10 = findViewById(R.id.mtr_sem5_spin10);
    ...
    public void calculateGPA() {
        ...
        if (subject1.equals("Your grade") || subject2.equals("Your grade") || subject3.equals("Your grade")
            ...
            Intent intent = new Intent(Mechatro_sem5.this, GPA_ResultActivity.class);

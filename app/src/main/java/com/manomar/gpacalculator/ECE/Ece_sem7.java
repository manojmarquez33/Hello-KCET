...
public class Ece_sem7 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cal_gpa = findViewById(R.id.btn_ece_gpa_sem7);

        getSupportActionBar().setTitle("ECE Semester 7");
        ActionBar actionBar = getSupportActionBar();
        actionBar.setDisplayShowHomeEnabled(true);
        actionBar.setDisplayHomeAsUpEnabled(true);


        spinner1 = findViewById(R.id.ece_sem7_spin1);
        spinner2 = findViewById(R.id.ece_sem7_spin2);
        spinner3 = findViewById(R.id.ece_sem7_spin3);
        spinner4 = findViewById(R.id.ece_sem7_spin4);
        spinner5 = findViewById(R.id.ece_sem7_spin5);
        spinner6 = findViewById(R.id.ece_sem7_spin6);
        spinner7 = findViewById(R.id.ece_sem7_spin7);
        //spinner8 = findViewById(R.id.ece_sem7_spin8);

        //spinner9 = findViewById(R.id.ece_sem7_spin9);
        //spinner10 = findViewById(R.id.ece_sem7_spin10);
    ...
    public void calculateGPA() {
        ...
        if (subject1.equals("Your grade") || subject2.equals("Your grade") || subject3.equals("Your grade")
            ...
            float total_sem7 = sub1 + sub2 + sub3 + sub4 + sub5 + sub6 + sub7;
            double gpa_sem7 = total_sem7 / total_credits;


            cal_gpa.setClickable(true);
            Intent intent = new Intent(Ece_sem7.this, GPA_ResultActivity.class);

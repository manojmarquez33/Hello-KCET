...
public class Ece_sem6 extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        cal_gpa = findViewById(R.id.btn_ece_gpa_sem6);

        getSupportActionBar().setTitle("ECE Semester 6");
        ActionBar actionBar = getSupportActionBar();
        actionBar.setDisplayShowHomeEnabled(true);
        actionBar.setDisplayHomeAsUpEnabled(true);


        spinner1 = findViewById(R.id.ece_sem6_spin1);
        spinner2 = findViewById(R.id.ece_sem6_spin2);
        spinner3 = findViewById(R.id.ece_sem6_spin3);
        spinner4 = findViewById(R.id.ece_sem6_spin4);
        spinner5 = findViewById(R.id.ece_sem6_spin5);
        spinner6 = findViewById(R.id.ece_sem6_spin6);
        spinner7 = findViewById(R.id.ece_sem6_spin7);
        spinner8 = findViewById(R.id.ece_sem6_spin8);

        spinner9 = findViewById(R.id.ece_sem6_spin9);
        //spinner10 = findViewById(R.id.ece_sem6_spin10);
    ...
    public void calculateGPA() {
        ...
        if (subject1.equals("Your grade") || subject2.equals("Your grade") || subject3.equals("Your grade")
            ...
            Intent intent = new Intent(Ece_sem6.this, GPA_ResultActivity.class);

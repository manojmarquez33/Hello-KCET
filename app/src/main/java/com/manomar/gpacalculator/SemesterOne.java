...
public class SemesterOne extends AppCompatActivity {
    ...
    public void calculateGPA() {
            ...
            if (English.equals("Your grade") || Maths.equals("Your grade") || Physics.equals("Your grade")
                    || POE.equals("Your grade") || Coding.equals("Your grade") || Chemistry.equals("Your grade")
                    || Mat_lab.equals("Your grade") || Phy_lab.equals("Your grade") || Code_lab.equals("Your grade")) {
                ...
                int sub3 = 0;
                if (Physics.equals("O - Outstanding")) {
                    sub3 = 3 * 10;
                ...
                //Chemistry-----------------------------------------
                int sub6 = 0;
                if (Chemistry.equals("O - Outstanding")) {
                    sub6 = 3 * 10;
                ...
                Intent intent = new Intent(SemesterOne.this, GPA_ResultActivity.class);
